...
class _GenericStageAxis(microscope.abc.StageAxis):
    ...
    def limits(self):
        ...
        return microscope.AxisLimits(lower=self._limits[0], upper=self._limits[1])
...
class BRamanZStage(microscope.abc.Stage):
    ...
    def limits(self):
        return self._axes["z"].limits() # TODO: This should be a named tuple AxisLimits(lower, upper)
