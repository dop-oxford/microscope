...
class CS165CUCamera(microscope.abc.Camera):
    ...
    def __init__(
        ...
        try:
            ...
            import sys
            sys.path.append(absolute_path_to_dlls)
        ...
        if ini_acq:
            # TODO -> Unless we import the old code, we need to redefine initialize_acquisition()
    ...
    def set_exposure_time(self, value):
        ...
        if self.simulated:
            ...
            print("Setting exposure time try 2")
            self.set_exposure_time_us(int(value+1 * 1e6))
    ...
    def initialize_acquisition(self):
        """Initializes camera acquisition with default parameters."""
        self._do_enable()
        self._do_trigger()
    ...
    def _fetch_data(self, rescale=False, target_bpp=8):
        ...
        #print(f"Acquiring image {self._acquiring}, Triggered {self._triggered}")
